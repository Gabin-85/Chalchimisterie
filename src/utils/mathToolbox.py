...
class Vector1D:
    ...
    def __repr__(self) -> str:
        ...
        return "Vector1D(x='{}')".format(self.x)
    
    def __copy__(self) -> 'Vector1D':
    ...
    # Operators #
    #############
    def __add__(self, object:'Vector1D') -> 'Vector1D':
        """Add the vector"""
        return Vector1D(self.x + object.x)
    
    def __iadd__(self, object:'Vector1D') -> 'Vector1D':
        """Add the vector"""
        self.x += object.x
        return self

    def __sub__(self, object:'Vector1D') -> 'Vector1D':
        """Subtract the vector"""
        return Vector1D(self.x - object.x)
    
    def __isub__(self, object:'Vector1D') -> 'Vector1D':
        """Subtract the vector"""
        self.x -= object.x
        return self

    def __mul__(self, object:'Vector1D') -> 'Vector1D':
        """Multiply the vector"""
        return Vector1D(self.x * object.x)
    
    def __imul__(self, object:'Vector1D') -> 'Vector1D':
        """Multiply the vector"""
        self.x *= object.x
        return self
    
    def __truediv__(self, object:'Vector1D') -> 'Vector1D':
        """Divide the vector"""
        return Vector1D(self.x / object.x)
    
    def __itruediv__(self, object:'Vector1D') -> 'Vector1D':
        """Divide the vector"""
        self.x /= object.x
        return self
    ...
    # Equivalence #
    ###############
    def __eq__(self, object:'Vector1D') -> bool:
        """Check if equal"""
        return self.x == object.x
    
    def __ne__(self, object:'Vector1D') -> bool:
        """Check if not equal"""
        return self.x != object.x
    
    def __lt__(self, object:'Vector1D') -> bool:
        """Check if less than"""
        return self.x < object.x
    
    def __gt__(self, object:'Vector1D') -> bool:
        """Check if greater than"""
        return self.x > object.x
    
    def __le__(self, object:'Vector1D') -> bool:
        """Check if less or equal"""
        return self.x <= object.x
    
    def __ge__(self, object:'Vector1D') -> bool:
    ...
    def scale(self, factor:float) -> 'Vector1D':
        """Get a scaled vector"""
        return Vector1D(self.x * factor)
