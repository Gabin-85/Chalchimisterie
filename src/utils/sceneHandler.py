...
class sceneHandler:
    ...
    def get_zoom(self):
        ...
        if screen_size[0] < screen_size[1]:
            map_zoom = screen_size[1]*self.tmx_zoom()/self.tmx_data().height/self.tmx_data().tileheight
        else:
            map_zoom = screen_size[0]*self.tmx_zoom()/self.tmx_data().width/self.tmx_data().tilewidth
        return map_zoom
    ...
    def tmx_zoom(self):
        ...
        return self.maps[self.map_name]["tmx_data"].get_layer_by_name("objects").properties["zoom"]
